...
![API](https://img.shields.io/badge/REST_API-009688?style=for-the-badge&logo=api&logoColor=white)
...
│  FRONTEND LAYER                                          │
│  ┌─────────────────────────────────────────────────┐    │
│  │ React | HTML5 | CSS3 | JavaScript | REST API   │    │
│  └─────────────────────────────────────────────────┘    │
│                       ↕                                  │
│  BACKEND LAYER                                           │
│  ┌─────────────────────────────────────────────────┐    │
...
│  ┌─────────────────────────────────────────────────┐    │
│  │ Docker | AWS | Google Cloud | Linux | Git      │    │
│  └─────────────────────────────────────────────────┘    │
│                                                           │
└──────────────────────────────────────────────────────────┘
```
...
╔════════════════════════════════════════════════════════════════╗
║                                                                ║
║          🎯 B.NIKESH - AI ENGINEER & FULL STACK DEVELOPER    ║
║                                                                ║
║  ⚡ Expertise: AI | ML | NLP | Full Stack Development        ║
║  🎓 Education: B.Tech CS from KG Reddy Engineering College   ║
║  📍 Location: India                                           ║
║  🚀 Status: Student | Open to Opportunities                  ║
║                                                                ║
║  🛠️  Tech Stack: Python | JavaScript | Java | React | Django  ║
║  ☁️  Cloud: AWS | Google Cloud | Docker                       ║
║  🤖 Specialization: NLP | Machine Learning | Resume Screening ║
║                                                                ║
╚════════════════════════════════════════════════════════════════╝
```
...
| 🎯 **Passion** | 🚀 **Innovation** | 💡 **Problem Solver** |
|:---:|:---:|:---:|
| Building AI solutions | Exploring new tech | Creating impact |
| **⚙️ Collaborator** | **📚 Learner** | **🏆 Achiever** |
| Team player | Always growing | Certified & skilled |
...
```
2022-2024: Learning & Building Foundations
           ↓
2024-Present: Full Stack Development & AI/ML Focus
           ↓
Future: Contributing to Industry & Open Source 🚀
```
